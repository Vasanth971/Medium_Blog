import { SignupInput } from "@vasanth-kumar/medium-blog";
            ...
            <div>
                <div className="px-10">
                    ...
                    <div className="flex justify-center text-slate-400">
                        {type === "signin" ? "Don't have an account?" : "Aready have an account?"} 
                        <Link className="pl-2 underline" to={type === "signin" ? "/signup" : "/signin"}>{type === "signin" ? "Sign up" : "Sign in"}</Link>
                    </div>
                </div>
                <div className="pt-8">
                    { type === "signup" ? <LabelledInput label="Name" placeholder="Vasanth Kumar..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null }
                    <LabelledInput label="Username" placeholder="vasanth@gmail.com" onChange={(e)=> {
                        setPostInputs({
                            ...postInputs,
                            username: e.target.value
                        })
                    }}/>
                    <LabelledInput label="Password" type={"password"} placeholder="v1234123" onChange={(e)=> {
                        setPostInputs({
                            ...postInputs,
